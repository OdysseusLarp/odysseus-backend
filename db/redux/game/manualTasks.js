...
[
	...
	},
	{
		...
		config: {
			...
			pages: [
				'<p>Perform the manual task according to instructions.</p><p>The isotopic gamma-spore reader is dirty and needs to be cleaned.</p><p>Isotopic particle detector K1p (model SICK) is located in the war room. Refer to ESS Odysseus Operations Handbook page 2.6-56 for instructions.</p>',
	...
	},
	{
		...
		config: {
			...
			pages: [
				'<p>Perform the manual task according to instructions.</p><p>Due to some unclear anomalies, the power of the gamma-wave shifter needs to be changed according to current circumstances.</p><p>The Neogenic capacitator GR3914D - power of the gamma-wave shifter is located in the security room. Refer to ESS Odysseus Operations Handbook page 2.6-56 for instructions.</p>',
	...
	},
	{
		...
		config: {
			...
			pages: [
				'<p>Perform the manual task according to instructions.</p><p>Reprogram the delta-wave fuse box.</p><p>The Neogenic capacitator GR3914D is located in the security room. Refer to ESS Odysseus Operations Handbook page 2.6-56 for instructions.</p>',
	...
	},
	{
		...
		config: {
			...
			pages: [
				'<p>Perform the manual task according to instructions.</p><p>In order to resynchronise the rear shield’s positronic stabilizer, it needs to be reset.</p><p>The Neogenic capacitator GR3914D is located in the security room. Refer to ESS Odysseus Operations Handbook page 2.6-56 for instructions.</p>',
	...
	//Captains quarters
	{
		...
		config: {
			...
			pages: [
				'<p>Perform the manual task according to instructions.</p><p>The promethium warp fragmenter is an indispensable, usually autonomously operating part of the maneuvering system. The coding panel is used to manually re-code the system.</p><p>Promethium warp fragmentor Y99y is located in the captains quarters. Refer to ESS Odysseus Operations Handbook page 2.6-56 for instructions.</p>',
				'<p>Flick switches as follows:</p><ul><li>Switches 1, 2, 6, 8, 10 --> ON</li><li>Switches 3, 4, 5, 7, 9 --> OFF</li></ul>',
				'<p>Move to calibrating when complete.</p>'
			],
			buttons: [
	...
	
	{
		...
		config: {
			...
			pages: [
				'<p>Perform the manual task according to instructions.</p><p> A buildup of alpha and beta particles has been observed, and the switch needs to be flicked to reroute energy to alternative charge splitters.</p><p>The Radiation containment switch 464-900 is located above the mess hall. Refer to ESS Odysseus Operations Handbook page 2.6-56 for instructions.</p>',
	...
	// },
	{
		...
		config: {
			...
			pages: [
				'<p>Perform the manual task according to instructions.</p><p>A very rare malfunction occurred. The Hyperclean function has been activated for too long and the Roomba’s programming has started to interpret hypercleaning as making sure all sources of filth, in this context, humans, are exterminated. The hyperclean function should be deactivated.</p><p>The Roomba (old model, brand: Samsung) is located in the green room. Refer to ESS Odysseus Operations Handbook page 2.6-56 for instructions.</p>',
	...
	},
	{
		...
		config: {
			...
			pages: [
				'<p>Perform the manual task according to instructions.</p><p>The argon quantum shift propulsion of the beam weapons is no longer synchronized, so the setting has been recalculated and needs to be changed.</p><p>The Versatile Voltmeter B7-17 (model 562) is located in the science lab. Refer to ESS Odysseus Operations Handbook page 2.6-56 for instructions.</p>',
	...
	},
	{
		...
		config: {
			...
			pages: [
				'<p>Perform the manual task according to instructions.</p><p>Plasma surges have been observed in the core. The system needs to be reset and reprogrammed to avoid a potentially critical plasma surge.</p><p>Zirconium gluon gel core control panel is located in the med bay. Refer to ESS Odysseus Operations Handbook page 2.6-56 for instructions.</p>',
...
[
	...
	},
	{
		...
		calibrationTime: 200,
		title: 'Dorsal ion bio-filter G5He A',
		description: 'The filter is causing quantum surges that will overload the general hull system if not fixed. The filter’s crystal core needs to be re-attenuated. Manual labor is needed. Perform the manual task according to instructions.The Dorsal ion bio-filter G5He is located in the corridoor. Refer to ESS Odysseus Operations Handbook page 2.6-56 for instructions. Use HANSCA repair for calibration.',
	...
	},
	{
		...
		calibrationTime: 240,
		title: 'Front shield antilepton control switchboard 473f A',
		description: 'This combination of switchboards manually controls the front shield antilepton commands. Manual labor is needed. Perform the manual task according to instructions. The Front shield antilepton control switchboard 473f is located in the crew bar. Refer to ESS Odysseus Operations Handbook page 2.6-56 for instructions. Use HANSCA repair for calibration.',
	...
	},
	{
		...
		calibrationTime: 205,
		title: 'Gamma-wave missile driver control unit Rr34c A',
		description: 'This unit functions as a secondary motherboard for programming some key commands for the gamma-wave missile system. Manual labor is needed. Perform the manual task according to instructions. The Gamma-wave missile driver control unit Rr34c is located in the bridge. Refer to ESS Odysseus Operations Handbook page 2.6-56 for instructions. Use HANSCA repair for calibration.',
	...
	},
	{
		...
		calibrationTime: 50,
		title: 'Gluon impulse control circuit switchboard 2f345G A',
		description: 'This switchboard re-routes the nitronium flow from the gluon core to the missile propeller systems. In order to ensure the safety of the ship, the nitronium flow needs to be frequently re-routed. Manual labor is needed. Perform the manual task according to instructions. The Gluon impulse control circuit switchboard 2f345G is located in the armory. Refer to ESS Odysseus Operations Handbook page 2.6-56 for instructions. Use HANSCA repair for calibration.',
		location: 'Lower deck, armory',
		map: 'deck1',
		mapX: 560, // X coordinate in image
	...
	},
	{
		...
		description: 'This unit controls the backup power for the impulse engine. If any anomalies outside of the normal range occur, it may have a critical effect on the energy supply of the impulse engine. Manual labor is needed. Perform the manual task according to instructions. The Impulse engine backup power regulation unit B33e is located in the bridge. Refer to ESS Odysseus Operations Handbook page 2.6-56 for instructions. Use HANSCA repair for calibration.',
		location: 'Upper deck, bridge',
		map: 'deck2',
	...
	},
	{
		...
		calibrationTime: 50,
		title: 'Unidedified articles on Isotopic particle detector K1p (model SICK)',
		description: 'This unit detects any anomalies in isotopic particles and communicates this information to the ship’s central maneuvering system. The isotopic gamma-spore reader needs to be cleaned to ensure optimal performance. Manual labor is needed. Perform the manual task according to instructions. The Isotopic particle detector K1p (model SICK) is located in the war room. Refer to ESS Odysseus Operations Handbook page 2.6-56 for instructions. Use HANSCA repair for calibration.',
	...
	},
	{
		...
		description: 'This capacitator supports the correct functioning of several of the ship’s systems. The ship’s beam weapons system relies on the support of the gamma-wave shifter to keep power surges within an acceptable range. Manual labor is needed. Perform the manual task according to instructions. The Neogenic capacitator GR3914D - controlling the power of the gamma-wave shifter is located in the security room. Refer to ESS Odysseus Operations Handbook page 2.6-56 for instructions. Use HANSCA repair for calibration.',
	...
	},
	{
		...
		description: 'This capacitator supports the correct functioning of several of the ship’s systems. The missile system is observed to be producing abnormal delta-wave pulse signatures. Manual labor is needed. Perform the manual task according to instructions. The Neogenic capacitator GR3914D is located in the security room. Refer to ESS Odysseus Operations Handbook page 2.6-56 for instructions. Use HANSCA repair for calibration.',
		location: 'Upper deck, security room',
		map: 'deck2',
		mapX: 255, // X coordinate in image
		mapY: 1895 // Y coordinate in image
	...
	},
	{
		...
		description: 'This capacitator supports the correct functioning of several of the ship’s systems. This unit also contains the dilithium containment core control panel. Manual labor is needed. Perform the manual task according to instructions. The Neogenic capacitator GR3914D is located in the security room. Refer to ESS Odysseus Operations Handbook page 2.6-56 for instructions. Use HANSCA repair for calibration.',
		location: 'Upper deck, security room',
		map: 'deck2',
		mapX: 255, // X coordinate in image
		mapY: 1895 // Y coordinate in image
	...
	},
	{
		...
		description: 'This capacitator supports the correct functioning of several of the ship’s systems. In case of temporal anomalies, the rear shield’s positronic stabilizer should be resynchronised. Manual labor is needed. Perform the manual task according to instructions. The Neogenic capacitator GR3914D is located in the security room. Refer to ESS Odysseus Operations Handbook page 2.6-56 for instructions. Use HANSCA repair for calibration.',
		location: 'Upper deck, security room',
		map: 'deck2',
		mapX: 255, // X coordinate in image
		mapY: 1895 // Y coordinate in image
...

	{
		...
		calibrationTime: 420,
		title: 'Promethium warp fragmentor Y99y A',
		description: 'The promethium warp fragmenter is an indispensable, usually autonomously operating part of the maneuvering system. The coding panel is used to manually re-code the system. Manual labor is needed. Perform the manual task according to instructions. The Promethium warp fragmentor Y99y is located in the captains quarters. Refer to ESS Odysseus Operations Handbook page 2.6-56 for instructions. Use HANSCA repair for calibration.',
	...
	},
	{
		...
		calibrationTime: 240,
		title: 'Radiation containment switch 464-900 A',
		description: 'This switch is used to reroute energy to alternative charge splitters when there’s a risk of buildup of alpha and beta particles. Manual labor is needed. Perform the manual task according to instructions. The Radiation containment switch 464-900 is located above the mess hall. Refer to ESS Odysseus Operations Handbook page 2.6-56 for instructions. Use HANSCA repair for calibration.',
	...
	// },
	{
		...
		calibrationTime: 870,
		title: 'Roomba (old model, brand: Samsung)',
		description: 'The roomba does a decent job at keeping the corridors clean. This model is equipped with a Hyperclean function, which is useful for heavy duty maintenance on larger surfaces. Manual labor is needed. Perform the manual task according to instructions. The Roomba (old model, brand: Samsung) is located in the green room. Refer to ESS Odysseus Operations Handbook page 2.6-56 for instructions. Use HANSCA repair for calibration.',
	...
	},
	{
		...
		calibrationTime: 130,
		title: 'Versatile Voltmeter B7-17 (model 562) A',
		description: ' This Voltmeter is used to synchronize the argon quantum shift propulsion of the beam weapons in order to ensure faultless and safe usage. Manual labor is needed. Perform the manual task according to instructions. The Versatile Voltmeter B7-17 (model 562) is located in the science lab. Refer to ESS Odysseus Operations Handbook page 2.6-56 for instructions. Use HANSCA repair for calibration.',
	...
	},
	{
		...
		calibrationTime: 210,
		title: 'Zirconium gluon gel core control panel - Re-routing control signals A',
		description: 'This control panel is used to manually control the zirconium gluon core that propels the impulse engine. It can be used for re-routing control signals for zirconium containment. Manual labor is needed. Perform the manual task according to instructions. The Zirconium gluon gel core control panel is located in the med bay. Refer to ESS Odysseus Operations Handbook page 2.6-56 for instructions. Use HANSCA repair for calibration.',
	...
	},
	{
		...
		description: 'This control panel is used to manually control the zirconium gluon core that propels the impulse engine. It can be used for resetting and reprogramming the system whenever a potentially critical plasma surge occurs. Manual labor is needed. Perform the manual task according to instructions. The Zirconium gluon gel core control panel is located in the med bay. Refer to ESS Odysseus Operations Handbook page 2.6-56 for instructions. Use HANSCA repair for calibration.',
		location: '2rd deck, med bay',
		map: 'deck2',
		mapX: 172, // X coordinate in image
		mapY: 1347 // Y coordinate in image
