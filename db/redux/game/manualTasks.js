...
blobs.push({
	...
	config: {
		...
		pages: [
			// Array of pages of instructions in HTML
		...
		buttons: [
			// Buttons to move to next page, or to mark task complete (last in array), must be of same length as 'pages'
			'Next',
			'Complete',
		],
	},
...
[
	...
	{
		id: 'reactor_reroute_a',
		type: 'game',
		task: 'reactor_reroute_a',
		game_config: 'manual',
		status: 'fixed',
		config: {
	...
	{
		id: 'reactor_reroute_b',
		type: 'game',
		task: 'reactor_reroute_b',
		game_config: 'manual',
		status: 'fixed',
		config: {
	...
	{
		id: 'reactor_reroute_c',
		type: 'game',
		task: 'reactor_reroute_c',
		game_config: 'manual',
		status: 'fixed',
		config: {
	...
	{
		id: 'reactor_reroute_d',
		type: 'game',
		task: 'reactor_reroute_d',
		game_config: 'manual',
		status: 'fixed',
		config: {
	...
	{
		id: 'reactor_reroute_e',
		type: 'game',
		task: 'reactor_reroute_e',
		game_config: 'manual',
		status: 'fixed',
		config: {
